...
@section('main-content')
    <section class="post-img" style="background-image: url(/upload/post/{{$post['id']}}_1.png);">
        <div class="container">
            <h1>{{$post['name']}}</h1>
        </div>
    </section>
    <section class="main-content">
        <div class="container">
            <div class="row pad-y-50">
{{--                <p class="col-md-12">--}}
{{--                    Lorem Ipsum "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci--}}
{{--                    velit..." "There is no one who loves pain itself, who seeks after it and wants to have it, simply--}}
{{--                    because it is pain..."--}}
{{--                </p>--}}
{{--                <p class="col-md-12">--}}
...
{{--                    It was popularised in the 19605 with the release of Letraset sheets containing Lorem Ipsum passages,--}}
...
{{--                    mom-or-less normal distribution of letters, as opposed to using 'Content here, content hem', making--}}
{{--                    it look like readable English. Many desktop publishing packages and web page editors now use Lorem--}}
{{--                    Ipsum as their default model text, and a search for 'Iorem ipsum' will uncover many web sites still--}}
...
{{--                    mots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard--}}
...
{{--                    them isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the--}}
{{--                    Internet tend to repeat predefined chunks as necessary, making this the first true generator on the--}}
{{--                    Intemet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence--}}
...
{{--                </p>--}}
                ...
                <img class="col-md-12" src="/upload/post/{{$post['id']}}_2.png">
            </div>
        </div>
    </section>
@endsection
